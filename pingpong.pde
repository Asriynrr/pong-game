...
void draw() {
 ...
 textSize(20);
 fill(0, 0, 255);
 text("Player", width/2+50, 30);
 fill(255, 0, 0);
 text("Computer", width/2-150, 30);
 textSize(50);
 fill(0, 0, 255);
 ...
 text("Use Mouse", width/2+width/4-320, height/2+25);
 text("To Control Paddle", width/2+width/4-350, height/2+50);
 }
 }
 }
}
